...
-- Create improved Stripe payment intent function with better error handling
  ...
  BEGIN
    ...
    FROM http((
      ...
      jsonb_build_object(
        ...
        'automatic_payment_methods', jsonb_build_object('enabled', true),
        ...
        'description', format('Payment for %s', customer_name)
      )::text
    ));
