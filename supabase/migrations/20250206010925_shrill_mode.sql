...
DROP FUNCTION IF EXISTS public.create_pix_payment(p_amount numeric, p_customer_name text, p_customer_document text, p_customer_email text);
...
CREATE OR REPLACE FUNCTION public.generate_pix_payment_v2(
  p_amount numeric,
...
GRANT EXECUTE ON FUNCTION public.generate_pix_payment_v2 TO anon;
GRANT EXECUTE ON FUNCTION public.generate_pix_payment_v2 TO authenticated;